...
public:
    ...
    [[nodiscard]] auto insert_dat_version(const core::DatVersion& dat)
        -> Result<std::int64_t>;
    ...
    [[nodiscard]] auto find_rom_by_md5(std::string_view md5)
        -> Result<std::optional<core::RomInfo>>;
    ...
    [[nodiscard]] auto upsert_rom_status(std::int64_t rom_id, core::RomStatusType status)
        -> Result<void>;
